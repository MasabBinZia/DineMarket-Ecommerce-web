    ...
    <nav>
      ...
      <div className='flex justify-between items-center mt-8 mx-4 sm:mx-8 md:mx-16 lg:mx-32'>
        ...
        >
          <div className=''>
          <div
            className={`navlinks ${isMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row gap-x-10`}
          >
          ...
          <div
            className={` ${isMenuOpen ? 'flex' : 'hidden'} md:flex h-10 w-10 rounded-full bg-gray-200 justify-center items-center cursor-pointer`}
          >
            <ShoppingCart />
          </div>
          </div>
