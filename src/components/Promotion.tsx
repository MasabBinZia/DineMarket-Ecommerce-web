      ...
      <div className="flex flex-col md:flex md:flex-row gap-4 item-center justify-center">
        ...
        <div className="flex items-center md:flex flex-col gap-4">
          ...
          <div className="w-[400px] md:h-52 md:w-[600px] flex flex-col items-center rounded justify-center gap-y-3 bg-zinc-800">
            ...
            <Button className="mb-4 md:text-lg tracking-widest text-white bg-zinc-700 px-4 py-1 rounded-lg hover:bg-zinc-700">
              DINEWEEKENDSALE
            </Button>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between items-center gap-4 md:flex md:flex-row">
          <div
            className="flex flex-col justify-between items-center rounded  pb-0 pt-3 px-2 w-80 md:w-56 h-[425px]"
